...
php7.4-zip php7.4-memcached php7.4-redis php7.4-dom
...
sed -i 's/;date.timezone =/date.timezone = Europe\/Istanbul/g' /etc/php/7.4/cgi/php.ini    # Zaman dilimi tanımlanıyor.
